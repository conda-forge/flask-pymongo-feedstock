...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-pymongo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13784&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-pymongo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-pymongo` can be installed with:

```
conda install flask-pymongo
```

It is possible to list all of the versions of `flask-pymongo` available on your platform with:
